...
# @nose= defines an ‘instance’ variable for an instance of the class
	...
	$('[story-id]').each ->
		story = new StoryInterface($(@), 'plan001')
...
# TODO : precharger les images
# précharger les plans dans l'ordre
# un objet pour récupérer l'etat du plan suivant (visible sur le bouton)
# il peut aussi récupérer l'état total des plans
