...
(function() {
  $(document).ready(function() {
    var ImageItem, ImagePreloader, Plan, StoryInterface, imagePreloaderCounter;
    ...
    return $('[story-id]').each(function() {
      var story;
      story = new StoryInterface($(this), 'plan001');
      story.onStopPlan('plan001', function() {
        $('html head title').html('plan 001');
        return console.log('fin plan 001');
      });
      story.onStartAllPlans(function() {
        return console.log('start plan (all event)');
      });
      story.onStopAllPlans(function() {
        return console.log('stop plan (all event)');
      });
      story.onStartPlan('plan002', function() {
        return $('html head title').html('plan 002');
      });
      story.onStopPlan('plan002', function() {
        return console.log('fin plan 002');
      });
